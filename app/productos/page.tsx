...
export const metadata: Metadata = {
  ...
  description:
    "Catálogo completo: cerramientos de terraza, toldos y persianas, cortinas de vidrio panorámicas, mamparas de baño, puertas acorazadas, protección de viviendas, mosquiteras y enmarcado de cuadros en Torrox Costa.",
